...
const MoranaImageContainer = (props: IProps) => {
    ...
    return (
        <Box zIndex={5} minW={"300px"} width={["100%", "90%", "100%", "100%"]} height={["100%", "90%", "100%", "100%"]}>

            <Box position={"absolute"} pl={["0.7em"]} pt={["1em"]} width={"inherit"} height={"inherit"}>
                <Image
                    src={props.imagePath}
                    width={props.width}
                    height={props.height}
            ...
            <svg viewBox="0 0 268 252" fill="none" xmlns="http://www.w3.org/2000/svg"  width={"inherit"} height={"inherit"}>
                <path
